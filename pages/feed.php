...
$user_id = $_SESSION['id'];
$sql = "SELECT user_id FROM followers WHERE follower_id = $user_id AND id_status = 'accepted'";
...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($rows = mysqli_fetch_assoc($result)) {
        $followed_user_ids[] = $rows['user_id'];
    }

    $user_ids_string = implode(',', $followed_user_ids);
} else {
    $rows = [];
}
if (!empty($user_ids_string)) {
    $sql1 = "SELECT * FROM post 
                 ...
                 WHERE user_table.id IN ($user_ids_string,$user_id) 
        ...
        ?>
            <div class="post">
                ...
                <div class="show-likes">
                    ...
                    <p class="time"><?php echo date('d/n/Y', strtotime($row['upload_time'])); ?></p>
                    ...
                    <div class="modal-content">
                        <div style="overflow-y: auto;">
                            ...
                            <div class="comment-input">
                                <div class="comment">
                                    <img src="../process/upload/<?php echo $_SESSION['profile_image'] ?> " alt="User"
                                        style="box-shadow: 0px 8px 16px rgba(0.4, 0.4, 0.4, 0.4);">
                                </div>
